## Fubsub [![Test and lint](https://github.com/p14n/fubsub/actions/workflows/main-check.yaml/badge.svg)](https://github.com/p14n/fubsub/actions/workflows/main-check.yaml)
